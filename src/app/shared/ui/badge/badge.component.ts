...
@Component({
  ...
  template: `
    <span
      class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium text-nowrap border transition-colors"
...
export class BadgeComponent {
  ...
  protected readonly variantClasses: Record<BadgeVariant, string> = {
    ...
    WARNING: 'bg-state-warning-subtle text-state-warning border-state-warning',
    DANGER:  'bg-state-danger-subtle  text-state-danger  border-state-danger',
    INFO:    'bg-state-info-subtle    text-state-info    border-state-info',
  };
